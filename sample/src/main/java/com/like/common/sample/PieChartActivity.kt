...
class PieChartActivity : BaseActivity() {
    ...
    fun getSimulatedData2(): PieData = PieData(2017, 2, listOf(MonthData(4, 400f, 400f), MonthData(5, 500f, 500f), MonthData(6, 600f, 600f)))

    fun getSimulatedData3(): PieData = PieData(2017, 3, listOf(MonthData(7, 700f, 700f), MonthData(8, 800f, 800f), MonthData(9, 900f, 900f)))
}