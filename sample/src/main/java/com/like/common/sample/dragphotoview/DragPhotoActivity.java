...
import com.like.common.view.dragphotoview.OnTapListener;
...
public class DragPhotoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            getWindow().setStatusBarColor(ContextCompat.getColor(this, R.color.common_transparent));
        }
        ...
        for (int i = 0; i < mPhotoViews.length; i++) {
            mPhotoViews[i] = (DragPhotoView) View.inflate(this, R.layout.item_dragphoto_viewpager, null);
            mPhotoViews[i].setImageResource(R.drawable.wugeng);
            mPhotoViews[i].setMTapListener(new OnTapListener() {
                @Override
            ...
            mPhotoViews[i].setMExitListener(new OnExitListener() {
                @Override
        ...
        mViewPager.getViewTreeObserver()
                .addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        ...
                        for (int i = 0; i < mPhotoViews.length; i++) {
                            mPhotoViews[i].getMAnimationManager().setMMinScale(mScaleX);
                        }
                    }
                });
    }
    ...
    private void performExitAnimation(final DragPhotoView view, float x, float y, float w, float h) {
        view.getMAnimationManager().finish();
