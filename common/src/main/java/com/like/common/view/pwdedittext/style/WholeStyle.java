...
import com.like.common.view.pwdedittext.textshap.ITextShap;
...
public class WholeStyle implements IStyle {
     ...
     */
    public WholeStyle(boolean hasRound, int roundRadius, ITextShap textShap) {
        mHasRound = hasRound;
