...
import com.like.common.view.pwdedittext.textshap.CircleShap;
...
public class PasswordEditText extends FrameLayout {
    ...
    private void initPasswordView() {
        mPasswordView.setStyle(new WholeStyle(true, DimensionUtils.dp2px(getContext(), 3f), new CircleShap()))
